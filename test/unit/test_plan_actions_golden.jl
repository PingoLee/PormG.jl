...
@testset "Plan actions from the typed delta (#507 phase 2)" begin
  ...
  @testset "identity: flavour change renders SET, not ADD or DROP (#523)" begin
    ...
    for (declared, live, expected) in ((always, bydef, "SET GENERATED ALWAYS"),
      ...
      sql = Dialect.alter_field(GPG507, "child_t", "col", declared, live, delta)
    ...
    add_sql = Dialect.alter_field(GPG507, "child_t", "col", bydef, Models.IntegerField(), add_delta)
    ...
    add_always_sql = Dialect.alter_field(GPG507, "child_t", "col", always, Models.IntegerField(),
                                         add_always_delta)
    ...
    drop_sql = Dialect.alter_field(GPG507, "child_t", "col", Models.UUIDField(), bydef, drop_delta)
