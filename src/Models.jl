...
@kwdef mutable struct sIDField <: PormGField
  ...
  generated::Bool = true  # New field to indicate GENERATED BY DEFAULT AS IDENTITY
end

function IDField(; verbose_name=nothing, primary_key=true, auto_increment=true, unique=true, blank=false, null=false, db_index=false, default=nothing, editable=false, generated=true)
  ...
  return sIDField(
    ...
    unique=unique, blank=blank, null=null, db_index=db_index, default=default, editable=editable, generated=generated
  ) 
end
