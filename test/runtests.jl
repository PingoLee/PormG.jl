...
@testset "PormG Unit Tests" begin
    ...
    @testset "Model Field Order (#544)" include("unit/test_model_field_order.jl")
    ...
    @testset "default= Converter Return Contract (#631)" include("unit/test_default_converter_contract.jl")
    ...
    @testset "Connection-String Redaction (#649)" include("unit/test_redact_secret.jl")
    ...
    @testset "update() values() Projection (#668)" include("unit/test_update_values_projection.jl")
    ...
    @testset "Migration Diff: FK constraint actions on rename + SQLite add (#504/#505)" include("unit/test_fk_constraint_actions.jl")
    @testset "Migration Diff: a unique rename keeps its constraint, a new SQLite FK gets one (#515/#514)" include("unit/test_rename_unique_index.jl")
    @testset "Migration Plan: actions derive from the typed delta (#507 phase 2)" include("unit/test_plan_actions_golden.jl")
    ...
    @testset "Skill GraphQL Pagination (#625)" include("unit/test_skill_graphql_pagination.jl")
