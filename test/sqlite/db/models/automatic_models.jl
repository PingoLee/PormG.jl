...
rel_cols = Models.Model("rel_cols", # TODO fix the table foreign keys
  id = Models.IDField(null=true),
  banco_id = Models.ForeignKey("bancos", pk_field="id"),
...
opc_cruzamento = Models.Model("opc_cruzamento",
  ...
  b2_id = Models.IntegerField(), # TODO fix the ForeignKey import
  nome = Models.CharField(null=true),
  obs = Models.CharField())
...
list_cruz = Models.Model("list_cruz",
  ...
  levnm = Models.BigIntegerField(), # TODO fix the data type; it shouldn't be BigIntegerField
