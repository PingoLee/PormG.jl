...
function field_to_column(col_name::String, field::PormGField, conn::Union{LibPQ.Connection, SQLite.DB})
...
function alter_field(conn::LibPQ.Connection, table_name::String, field_name::String, new_field::PormGField, colect_not_equal::Vector{Symbol})::String
  sql_statements = []
  ...
  XXX::Vector{Symbol} = [:type, :max_length, :max_digits, :decimal_places, :null, :unique, :default, :primary_key, :generated, :generated_always, :blank]
